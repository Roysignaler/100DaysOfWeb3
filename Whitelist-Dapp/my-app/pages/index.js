...
export default function Home() {
  ...
  const numberOfWhitlistLeft = 100 - numberOfWhitelisted;
      ...
      if (joinedWhitelist) {
        return (
          <div className={styles.description}>
            <p className={styles.title}> WAGMI!</p>
            WAGMI! Mostly we will be having fun. Follow <a href="https://twitter.com/Roysignaler">Roysignaler</a> for updates 🎉
          </div>
        );
      } else if (loading) {
        ...
        return (
          <button onClick={addAddressToWhitelist} className={styles.button85}>
            Join the Whitelist
          </button>
        );
      }
    ...
    <div>
      ...
      <div className={styles.main}>
        <div>
          ...
          <div className={styles.description}>
          <a href="https://polygonscan.com/address/0x65e6ac1e7db06c811c7346c19f770dd368493f79#code"> The smart contract is verified ✅ Read it yourself 📖 </a>
          </div>
        ...
        <div>
          <img className={styles.image} src="./polygon-matic-logo.svg" />
        </div>
      </div>
